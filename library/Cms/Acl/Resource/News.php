<?php
class Cms_Acl_Resource_News extends System_Model_News implements Zend_Acl_Resource_Interface
{
    ...
    {
        if(!isset($role))
        $this->_role = new Cms_Acl_Role_Cms;
        return $this;
    }
    public function getRole()
    {
        $this->_role = new Cms_Acl_Role_User();
        return $this->_role;
    }
    ...
    public function save(array $data)
    {
        ...
        {
            throw new Cms_Acl_Exception('Insufficient Privileges');
        }
    }
