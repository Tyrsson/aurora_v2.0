<?php
class Cms_Acl_Acl extends Zend_Acl
{
		public $user;
        public function __construct($auth = null)
        {
            $guest = new Cms_Acl_Role_Guest();
            $mod   = new Cms_Acl_Role_Mod();
            $admin = new Cms_Acl_Role_Admin();
            $temp = new Cms_Acl_Role_User();
            $defaultRole = $temp->getDefaultRole();
            $userRole = new Cms_Acl_Role_User();

            $this->addRole('guest');
            $this->addRole('user', 'guest'); //TODO: return this from db query through Cms_Acl_Role_User()
            ...
            $this->addResource(new Zend_Acl_Resource('resources.admin.reservations'));
             ...
             */
            //$this->deny(new Cms_Acl_Role_User(), null, array('guest:login', 'guest:register'));
        }
        protected function addRoles()
        {
        	$rModel = new Cms_Model_AclRoles();
